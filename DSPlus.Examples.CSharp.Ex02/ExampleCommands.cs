...
namespace DSPlus.Examples
{
    public class ExampleUngrouppedCommands
    {
        ...
        [Command("yoyo")] // let's define this method as a command
        [Description("Example ping command")] // this will be displayed to tell users what this command does when they invoke help
        [Aliases("dong")] // alternative names for the command
        public async Task someting(CommandContext ctx) // this command takes no arguments
        {
            ...
            var embed = new DiscordEmbedBuilder {
                Title = "PotatoBot",
                Description = $"{emoji} I await your instructions.",
